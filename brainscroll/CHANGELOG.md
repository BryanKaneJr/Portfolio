...
- **Mascot defined:** `docs/mascot.md` describes the Professor, an original cute old genius (not Einstein, whose likeness is licensed), with 29 poses for lessons, feedback, progress screens and subjects, plus how to keep him consistent across images. He isn't in the app yet, and his name is still open.
