...
- **Sample rewrite, Astronomy Levels 1–3:** about 190–200 words of learning each (from about 100–125), every card on its level's concept and made memorable (how we know, the why, concrete scale). Every sentence maps to a registered fact: most reuse facts already fact-checked in later levels, and two are new (NASA's front-door-and-nickel comparison and the Sun's gravity holding the solar system together), each fact-checked against NASA on 2026-09-25. None is human-verified.
