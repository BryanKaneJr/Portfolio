...
- `npm run check`: typecheck all workspaces, lint the app (hook-order bugs are errors), run core and admin unit tests, and validate `content/`. Run it before every commit.
