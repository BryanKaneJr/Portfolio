...
- **Later chapters ask more.** Future chapters follow the understanding arc and Dr. Scroll's teaching asides in `docs/writing/chapter-brief.md` (content rules, no new app systems). Retrofitting the existing trees and Choose For Me (idea 2) are not scheduled.
