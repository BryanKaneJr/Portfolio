...
- **Level scroll:** learning first. Hook → 3–5 focused learning cards → 3 light questions (recall, understanding, connection) → Level Complete. It's finite with a saved place and ends on a reward like "+100 XP · Perfect Recall · Level 19 unlocked", with the next level offered immediately.
